...
func registerCommonAuthenticationServerProtocols() {
	...
	port, _ := strconv.Atoi(os.Getenv("PN_SM4SH_SECURE_SERVER_PORT"))

	secureStationURL := types.NewStationURL("")
	secureStationURL.SetURLType(constants.StationURLPRUDPS)
	secureStationURL.SetAddress(os.Getenv("PN_SM4SH_SECURE_SERVER_HOST"))
	...
	commonTicketGrantingProtocol.BuildName = types.NewString("branch:origin/project/appcrf build:3_6_35_2000_0")
